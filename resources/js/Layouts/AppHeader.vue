                ...
                <div class="app-navbar flex-shrink-0">
                        ...
                        <form @submit.prevent="search" class="card-header justify-content-start py-4 px-4 gap-2 gap-md-5">
                            <div class="d-flex align-items-center position-relative">
                                <span class="svg-icon svg-icon-1 position-absolute ms-4"><svg width="24" height="24"
                                    ...
                                    </svg></span><input type="text" class="form-control form-control-solid w-250px ps-14"
                        ...
                        <div v-if="themeModeDrop"
                            ...
                            <div class="menu-item px-3 my-0">
                                <button @click="handleThemeChange('light')"
                                    :class="`menu-link w-100 border-0 px-3 py-2 bg-transparent ${theme === 'light' && 'active'}`"
                            ...
                            <div class="menu-item px-3 my-0">
                                <button @click="handleThemeChange('dark')"
                                    :class="`menu-link w-100 border-0 px-3 py-2 bg-transparent ${theme === 'dark' && 'active'}`"
                            ...
                            <!--begin::Menu item-->
                            <div class="menu-item px-3 my-0">
                                <button @click="handleThemeChange('system')"
                                    :class="`menu-link w-100 border-0 px-3 py-2 bg-transparent ${theme === 'system' && 'active'}`"
                    ...
                    <div class="app-navbar-item ms-1 ms-md-3">
                        ...
                        <div aria-labelled:by="dropdown-profile"
                                ...
                                <div class="menu-content d-flex align-items-center px-3">
                                    ...
                                    <div class="d-flex flex-column">
                                        <div class="fw-bold d-flex align-items-center fs-5">
                                            ...
                                            {{ $page.props.ziggy?.user.last_name }}
                            ...
                            <div class="menu-item px-5" v-if="$page?.props?.ziggy?.user?.role?.role?.slug != 'user'">

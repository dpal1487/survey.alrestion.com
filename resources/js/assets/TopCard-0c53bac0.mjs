...
/* empty css                 */import MappingForm from "./MappingForm-8a23e7a6.mjs";
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="mb-5"><div class="card"><div class="card-header align-items-center my-5"><div class="card-title"><h2>#${ssrInterpolate(_ctx.project.project_uid)} (${ssrInterpolate(_ctx.project.project_name)})</h2></div><div class="flex-shrink-0">`);
  if (!_ctx.isEdit) {
  ...
  if (_ctx.isEdit) {
    ...
    _push(`<div class="row p-5"><div class="col-md-8"><table class="table table-striped table-bordered text-center align-middle"><tbody><tr><th> Project ID </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.project_uid)}</td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Project Name </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.project_name)}</td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Project Link </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.project_link)}</td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Client Name </th><td class="fs-6 fw-bold text-gray-800">`);
    _push(ssrRenderComponent(_component_Link, {
    ...
    _push(`</td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Project Country </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.country.display_name)}</td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Sample Size </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.sample_size)}N </td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Project CPI </th><td class="fs-6 fw-bold text-gray-800"> $${ssrInterpolate(_ctx.project.cpi)}</td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Project LOI </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.loi)} Min </td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Incidence Ratio </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.ir)}% </td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap", "min-width": "150px" })}"> Project Status </th><td class="fs-6 fw-bold text-gray-800">`);
    if (_ctx.project.status) {
      _push(`<span class="badge badge-success">Active</span>`);
    } else {
      _push(`<span class="badge badge-danger">Inactive</span>`);
    }
    _push(`</td></tr><tr><th style="${ssrRenderStyle({ "white-space": "nowrap" })}"> Target </th><td class="fs-6 fw-bold text-gray-800">${ssrInterpolate(_ctx.project.target)}</td></tr></tbody></table></div><div class="col-md-4"><div class="h-100 d-flex justify-content-center align-items-center bg-gray-100"><div class="text-center">`);
    if (_ctx.project.status) {
      _push(`<div class="badge badge-success"> Active </div>`);
    } else {
      _push(`<div class="badge badge-danger"> Inactive </div>`);
    }
    _push(`<div class="d-flex justify-content-center align-items-center"><h1>${ssrInterpolate(_ctx.project.reports.complete)}  </h1><span>Out Of</span><h1> ${ssrInterpolate(_ctx.project.sample_size)}</h1></div><div class="d-flex justify-content-center align-items-center"><span>Actula IR </span><h1>${ssrInterpolate(_ctx.project.reports.total_ir)}%</h1></div></div></div></div></div>`);
  }
  _push(`<ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold px-5"><li class="nav-item">`);
  _push(ssrRenderComponent(_component_Link, {
    class: [

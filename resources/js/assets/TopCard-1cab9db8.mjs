...
/* empty css                 */import { ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderClass, ssrRenderStyle } from "vue/server-renderer";
...
const _sfc_main = defineComponent({
  ...
  methods: {
    formSubmit(e) {
      ...
      this.isLoading = true;
      axios.post(`/project/${this.project.id}/importid`, formData, config).then(function(response) {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="card card-flush mb-5"><div class="card-header align-items-center"><div class="card-title"><h2> #${ssrInterpolate(_ctx.project.project_id)} (${ssrInterpolate(_ctx.project.project_name)}) </h2></div>`);
  if (_ctx.$page.props.user.role.role.slug != "user") {
    _push(`<div><label class="btn btn-primary btn-sm" for="importId"><span class="d-flex align-items-center"><i class="bi bi-file-earmark-arrow-down"></i><span>Import ID&#39;s</span><input type="file" id="importId" class="d-none"></span></label><a target="_blank" class="btn btn-primary m-1 btn-sm"${ssrRenderAttr("href", `/project/${_ctx.project.id}/export`)}><i class="bi bi-file-earmark-arrow-up"></i>Export ID&#39;s </a><a target="_blank"${ssrRenderAttr("href", `/project/${_ctx.project.id}/report`)} class="btn btn-primary m-1 btn-sm"><i class="bi bi-graph-down-arrow"></i>Export Data </a><button class="btn btn-primary m-1 btn-sm"><i class="bi bi-pencil me-2"></i>Edit </button></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`</div><div class="card-body p-0"><div class="row">`);
  if (_ctx.isEdit) {
    _push(`<div class="col-12"><form autocomplete="off" class="ps-5 pt-5"><div class="row g-5"><div class="fv-row col-12">`);
    ...
    _push(`<!--]--></div><div class="fv-row col-md-6">`);
    _push(ssrRenderComponent(_component_jet_label, {
      for: "project-client",
    ...
    _push(`<!--]--></div><div class="fv-row col-md-6 fs-5">`);
    _push(ssrRenderComponent(_component_jet_label, {
      for: "project-start",
    ...
    _push(`<!--]--></div><div class="fv-row col-md-6 col-sm-12">`);
    _push(ssrRenderComponent(_component_jet_label, {
      for: "project-status",

  ...
  data() {
    ...
    return {
      form: this.$inertia.form({
        ...
        status: (_l = this.project) == null ? void 0 : _l.status,
        add_more: false
      })
    };
  },
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div class="input-group has-validation"><span class="input-group-text">$</span><input type="number" id="project-cpi" placeholder="Enter project CPI/CPC"${ssrRenderAttr("value", _ctx.v$.form.project_cpi.$model)} class="${ssrRenderClass([

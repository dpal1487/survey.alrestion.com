    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_Multiselect, {
          ...
          modelValue: _ctx.form.s,
          "onUpdate:modelValue": ($event) => _ctx.form.s = $event
        }, null, _parent2, _scopeId));
        _push2(`</div><button type="submit" class="btn btn-primary"${_scopeId}>Search</button></form><div class="card-body pt-0"${_scopeId}><div class="table-responsive"${_scopeId}><table class="table align-middle table-row-dashed fs-6 gy-5 text-left"${_scopeId}><thead${_scopeId}><tr class="text-gray-400 fw-bold fs-7 text-uppercase text-center"${_scopeId}><!--[-->`);
        ...
        if (_ctx.suppliers.meta) {
          _push2(`<div class="row mb-5 mx-5"${_scopeId}><div class="col-sm-12 d-flex align-items-center justify-content-between mb-5"${_scopeId}><span class="fw-bold text-gray-700"${_scopeId}> Showing ${ssrInterpolate(_ctx.suppliers.meta.from)} to ${ssrInterpolate(_ctx.suppliers.meta.to)} of ${ssrInterpolate(_ctx.suppliers.meta.total)} entries </span>`);
        ...
        return [
          ...
          createVNode("div", { class: "card card-flush mb-10" }, [
            createVNode("form", {
            ...
            createVNode("div", { class: "card-body pt-0" }, [
              createVNode("div", { class: "table-responsive" }, [
                createVNode("table", { class: "table align-middle table-row-dashed fs-6 gy-5 text-left" }, [
                  createVNode("thead", null, [
                    createVNode("tr", { class: "text-gray-400 fw-bold fs-7 text-uppercase text-center" }, [

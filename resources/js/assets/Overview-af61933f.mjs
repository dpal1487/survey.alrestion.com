...
import Header from "./Header-0a205aef.mjs";
  ...
  data() {
    ...
    return {
      ...
      form: this.$inertia.form({
        ...
        date_of_birth: new Date((_q = (_p = this.user) == null ? void 0 : _p.data) == null ? void 0 : _q.date_of_birth) || "",
        gender: ((_s = (_r = this.user) == null ? void 0 : _r.data) == null ? void 0 : _s.gender) || ""
      }),
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (_push2) {
        _push2(ssrRenderComponent(_component_Header, {
          user: (_a = _ctx.user) == null ? void 0 : _a.data
        ...
        if (_ctx.isEdit) {
          ...
          _push2(`<!--]--></div></div></div></div><div class="row mb-6"${_scopeId}><label class="col-lg-4 col-form-label fw-semibold fs-6"${_scopeId}>Date Of Birth</label><div class="col-lg-6"${_scopeId}><div class="fv-plugins-icon-container"${_scopeId}>`);
          ...
          _push2(`<div${_scopeId}><div class="card-body p-9"${_scopeId}><div class="row mb-7"${_scopeId}><label class="col-6 fw-bold fs-5 text-gray-800"${_scopeId}>Full Name</label><div class="col-lg-6"${_scopeId}><span class="fw-semibold fs-6 text-gray-800"${_scopeId}>${ssrInterpolate((_c = (_b = _ctx.user) == null ? void 0 : _b.data) == null ? void 0 : _c.first_name)} ${ssrInterpolate((_e = (_d = _ctx.user) == null ? void 0 : _d.data) == null ? void 0 : _e.last_name)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-6 fw-bold fs-5 text-gray-800"${_scopeId}>Email</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-semibold text-gray-800 fs-6"${_scopeId}>${ssrInterpolate((_g = (_f = _ctx.user) == null ? void 0 : _f.data) == null ? void 0 : _g.email)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-6 fw-bold fs-5 text-gray-800"${_scopeId}>DOB</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-semibold text-gray-800 fs-6"${_scopeId}>${ssrInterpolate((_i = (_h = _ctx.user) == null ? void 0 : _h.data) == null ? void 0 : _i.date_of_birth)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-6 fw-bold fs-5 text-gray-800"${_scopeId}>Gender</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-semibold text-gray-800 fs-6"${_scopeId}>${ssrInterpolate((_k = (_j = _ctx.user) == null ? void 0 : _j.data) == null ? void 0 : _k.gender)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-6 fw-bold fs-5 text-gray-800"${_scopeId}>Role</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-semibold text-gray-800 fs-6"${_scopeId}>${ssrInterpolate((_n = (_m = (_l = _ctx.user) == null ? void 0 : _l.data) == null ? void 0 : _m.role) == null ? void 0 : _n.name)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-6 fw-bold fs-5 text-gray-800"${_scopeId}>Status</label><div class="col-lg-6 fv-row"${_scopeId}><span class="${ssrRenderClass(`badge bg-${((_p = (_o = _ctx.user) == null ? void 0 : _o.data) == null ? void 0 : _p.status) == 1 ? "success" : "danger"}`)}"${_scopeId}>${ssrInterpolate(((_r = (_q = _ctx.user) == null ? void 0 : _q.data) == null ? void 0 : _r.status) ? "Active" : "Inactive")}</span></div></div></div></div>`);
        }
        _push2(`</div></div>`);
      } else {
        return [
          createVNode(_component_Header, {
            user: (_s = _ctx.user) == null ? void 0 : _s.data
          }, null, 8, ["user"]),
              ...
              _ctx.isEdit ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "card-body p-9" }, [
                  createVNode("div", { class: "row mb-7" }, [
                    ...
                    createVNode("div", { class: "col-lg-6" }, [
                      createVNode("span", { class: "fw-semibold fs-6 text-gray-800" }, toDisplayString((_u = (_t = _ctx.user) == null ? void 0 : _t.data) == null ? void 0 : _u.first_name) + " " + toDisplayString((_w = (_v = _ctx.user) == null ? void 0 : _v.data) == null ? void 0 : _w.last_name), 1)
                    ])
                  ]),
                  createVNode("div", { class: "row mb-7" }, [
                    createVNode("label", { class: "col-6 fw-bold fs-5 text-gray-800" }, "Email"),
                    createVNode("div", { class: "col-lg-6 fv-row" }, [
                      createVNode("span", { class: "fw-semibold text-gray-800 fs-6" }, toDisplayString((_y = (_x = _ctx.user) == null ? void 0 : _x.data) == null ? void 0 : _y.email), 1)
                    ])
                  ]),
                  createVNode("div", { class: "row mb-7" }, [
                    createVNode("label", { class: "col-6 fw-bold fs-5 text-gray-800" }, "DOB"),
                    createVNode("div", { class: "col-lg-6 fv-row" }, [
                      createVNode("span", { class: "fw-semibold text-gray-800 fs-6" }, toDisplayString((_A = (_z = _ctx.user) == null ? void 0 : _z.data) == null ? void 0 : _A.date_of_birth), 1)
                    ])
                  ]),
                  createVNode("div", { class: "row mb-7" }, [
                    createVNode("label", { class: "col-6 fw-bold fs-5 text-gray-800" }, "Gender"),
                    createVNode("div", { class: "col-lg-6 fv-row" }, [
                      createVNode("span", { class: "fw-semibold text-gray-800 fs-6" }, toDisplayString((_C = (_B = _ctx.user) == null ? void 0 : _B.data) == null ? void 0 : _C.gender), 1)
                    ])
                  ]),
                  createVNode("div", { class: "row mb-7" }, [
                    createVNode("label", { class: "col-6 fw-bold fs-5 text-gray-800" }, "Role"),
                    createVNode("div", { class: "col-lg-6 fv-row" }, [
                      createVNode("span", { class: "fw-semibold text-gray-800 fs-6" }, toDisplayString((_F = (_E = (_D = _ctx.user) == null ? void 0 : _D.data) == null ? void 0 : _E.role) == null ? void 0 : _F.name), 1)
                    ])
                  ]),
                  createVNode("div", { class: "row mb-7" }, [
                    ...
                    createVNode("div", { class: "col-lg-6 fv-row" }, [
                      createVNode("span", {
                        class: `badge bg-${((_H = (_G = _ctx.user) == null ? void 0 : _G.data) == null ? void 0 : _H.status) == 1 ? "success" : "danger"}`
                      }, toDisplayString(((_J = (_I = _ctx.user) == null ? void 0 : _I.data) == null ? void 0 : _J.status) ? "Active" : "Inactive"), 3)
                    ])
                  ])
                ])
              ]))

  ...
  data() {
    ...
    return {
      ...
      form: this.$inertia.form({
        ...
        notes: ((_p = (_o = this.supplier) == null ? void 0 : _o.data) == null ? void 0 : _p.notes) || "",
  ...
  _push(ssrRenderComponent(_component_AppLayout, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<form class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10"${_scopeId}><div class="card"${_scopeId}><div class="card-header"${_scopeId}><div class="card-title"${_scopeId}><h2${_scopeId}>General</h2></div></div><div class="card-body"${_scopeId}><div class="row g-5 col-md-12"${_scopeId}><div class="fv-row col-6"${_scopeId}>`);
        ...
        ])}" id="project-notes" placeholder="Type important message here..."${_scopeId}>${ssrInterpolate(_ctx.v$.form.notes.$model)}</textarea><!--[-->`);
        ...
        _push2(`<!--]--></div></div></div></div><div class="card"${_scopeId}><div class="card-header"${_scopeId}><div class="card-title"${_scopeId}><h2${_scopeId}>Supplier Redirects</h2></div></div><div class="card-body"${_scopeId}><div class="row g-5 col-md-12"${_scopeId}><div class="fv-row col-6"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "complete_url",
          value: "Complete URL"
        }, null, _parent2, _scopeId));

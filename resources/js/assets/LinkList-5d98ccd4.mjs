...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList(_ctx.links, (project, index) => {
    ...
    if (_ctx.$page.props.user.role.role.slug != "user") {
      ...
      if (project == null ? void 0 : project.user) {
        _push(`<span><i class="bi bi-people me-2"></i>${ssrInterpolate(project == null ? void 0 : project.user)}</span>`);
      } else {
        _push(`<span><i class="bi bi-people me-2"></i>Admin</span>`);
      }
      _push(`</div>`);
    } else {
      _push(`<!---->`);

    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (_push2) {
        ...
        if (_ctx.isEdit) {
          ...
          _push2(`<div${_scopeId}><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Supplier Name</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-bold fs-6 text-gray-700 text-capitalize"${_scopeId}>${ssrInterpolate((_c = (_b = this.supplier) == null ? void 0 : _b.data) == null ? void 0 : _c.supplier_name)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Display Name</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-bold fs-6 text-gray-700 text-capitalize"${_scopeId}>${ssrInterpolate((_e = (_d = this.supplier) == null ? void 0 : _d.data) == null ? void 0 : _e.display_name)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Email Address</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-bold fs-6 text-gray-700 text-capitalize"${_scopeId}>${ssrInterpolate((_g = (_f = this.supplier) == null ? void 0 : _f.data) == null ? void 0 : _g.email_address)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Website </label><div class="col-lg-6 d-flex align-items-center"${_scopeId}><span class="fw-bold fs-6 text-gray-700"${_scopeId}>${ssrInterpolate((_i = (_h = this.supplier) == null ? void 0 : _h.data) == null ? void 0 : _i.website)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Skype ID</label><div class="col-lg-6"${_scopeId}><span class="fw-bold fs-6 text-gray-700"${_scopeId}>${ssrInterpolate((_k = (_j = this.supplier) == null ? void 0 : _j.data) == null ? void 0 : _k.skype_profile)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Linked Profile ID</label><div class="col-lg-6"${_scopeId}><span class="fw-bold fs-6 text-gray-700"${_scopeId}>${ssrInterpolate((_m = (_l = this.supplier) == null ? void 0 : _l.data) == null ? void 0 : _m.linkedin_profile)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Country</label><div class="col-lg-6 fv-row"${_scopeId}><span class="fw-bold fs-6 text-gray-700"${_scopeId}>${ssrInterpolate((_p = (_o = (_n = this.supplier) == null ? void 0 : _n.data) == null ? void 0 : _o.country) == null ? void 0 : _p.display_name)}</span></div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Status</label><div class="col-lg-6"${_scopeId}>`);
          if (((_r = (_q = this.supplier) == null ? void 0 : _q.data) == null ? void 0 : _r.status) == 1) {
            _push2(`<span class="badge badge-success"${_scopeId}>Active</span>`);
          } else {
            _push2(`<!---->`);
          }
          if (((_t = (_s = this.supplier) == null ? void 0 : _s.data) == null ? void 0 : _t.status) == 0) {
            _push2(`<span class="badge badge-danger"${_scopeId}>Inactive</span>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`</div></div><div class="row mb-7"${_scopeId}><label class="col-lg-6 fw-bold fs-5 text-gray-800"${_scopeId}>Description</label><div class="col-lg-6"${_scopeId}><span class="fw-bold fs-6 text-gray-700"${_scopeId}>${ssrInterpolate((_v = (_u = this.supplier) == null ? void 0 : _u.data) == null ? void 0 : _v.description)}</span></div></div></div>`);
        }
        _push2(`</div></div>`);
      } else {
        return [
          createVNode(_component_Header, {
            supplier: (_w = _ctx.supplier) == null ? void 0 : _w.data
          }, null, 8, ["supplier"]),
              ...
              _ctx.isEdit ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "row mb-7" }, [
                  ...
                  createVNode("div", { class: "col-lg-6 fv-row" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700 text-capitalize" }, toDisplayString((_y = (_x = this.supplier) == null ? void 0 : _x.data) == null ? void 0 : _y.supplier_name), 1)
                  ])
                ]),
                createVNode("div", { class: "row mb-7" }, [
                  createVNode("label", { class: "col-lg-6 fw-bold fs-5 text-gray-800" }, "Display Name"),
                  createVNode("div", { class: "col-lg-6 fv-row" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700 text-capitalize" }, toDisplayString((_A = (_z = this.supplier) == null ? void 0 : _z.data) == null ? void 0 : _A.display_name), 1)
                  ])
                ]),
                createVNode("div", { class: "row mb-7" }, [
                  createVNode("label", { class: "col-lg-6 fw-bold fs-5 text-gray-800" }, "Email Address"),
                  createVNode("div", { class: "col-lg-6 fv-row" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700 text-capitalize" }, toDisplayString((_C = (_B = this.supplier) == null ? void 0 : _B.data) == null ? void 0 : _C.email_address), 1)
                  ])
                ]),
                createVNode("div", { class: "row mb-7" }, [
                  ...
                  createVNode("div", { class: "col-lg-6 d-flex align-items-center" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700" }, toDisplayString((_E = (_D = this.supplier) == null ? void 0 : _D.data) == null ? void 0 : _E.website), 1)
                  ])
                ]),
                createVNode("div", { class: "row mb-7" }, [
                  createVNode("label", { class: "col-lg-6 fw-bold fs-5 text-gray-800" }, "Skype ID"),
                  createVNode("div", { class: "col-lg-6" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700" }, toDisplayString((_G = (_F = this.supplier) == null ? void 0 : _F.data) == null ? void 0 : _G.skype_profile), 1)
                  ])
                ]),
                createVNode("div", { class: "row mb-7" }, [
                  createVNode("label", { class: "col-lg-6 fw-bold fs-5 text-gray-800" }, "Linked Profile ID"),
                  createVNode("div", { class: "col-lg-6" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700" }, toDisplayString((_I = (_H = this.supplier) == null ? void 0 : _H.data) == null ? void 0 : _I.linkedin_profile), 1)
                  ])
                ]),
                createVNode("div", { class: "row mb-7" }, [
                  createVNode("label", { class: "col-lg-6 fw-bold fs-5 text-gray-800" }, "Country"),
                  createVNode("div", { class: "col-lg-6 fv-row" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700" }, toDisplayString((_L = (_K = (_J = this.supplier) == null ? void 0 : _J.data) == null ? void 0 : _K.country) == null ? void 0 : _L.display_name), 1)
                  ])
                ]),
                createVNode("div", { class: "row mb-7" }, [
                  createVNode("label", { class: "col-lg-6 fw-bold fs-5 text-gray-800" }, "Status"),
                  createVNode("div", { class: "col-lg-6" }, [
                    ((_N = (_M = this.supplier) == null ? void 0 : _M.data) == null ? void 0 : _N.status) == 1 ? (openBlock(), createBlock("span", {
                      key: 0,
                      class: "badge badge-success"
                    }, "Active")) : createCommentVNode("", true),
                    ((_P = (_O = this.supplier) == null ? void 0 : _O.data) == null ? void 0 : _P.status) == 0 ? (openBlock(), createBlock("span", {
                      key: 1,
                ...
                createVNode("div", { class: "row mb-7" }, [
                  ...
                  createVNode("div", { class: "col-lg-6" }, [
                    createVNode("span", { class: "fw-bold fs-6 text-gray-700" }, toDisplayString((_R = (_Q = this.supplier) == null ? void 0 : _Q.data) == null ? void 0 : _R.description), 1)
                  ])
                ])
              ]))
            ])

  ...
  _push(ssrRenderComponent(_component_AppLayout, { title: _ctx.title }, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<form autocomplete="off" class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10"${_scopeId}><div class="card"${_scopeId}><div class="card-header"${_scopeId}><div class="card-title"${_scopeId}><h2${_scopeId}>General</h2></div></div><div class="card-body"${_scopeId}><div class="row g-5"${_scopeId}><div class="fv-row col-md-6 col-sm-12"${_scopeId}>`);
        ...
        _push2(`<!--]--></div><div class="fv-row col-md-6 col-sm-12"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "display-name",
          value: "Display Name"
        }, null, _parent2, _scopeId));
                ...
                createVNode("div", { class: "card" }, [
                  ...
                  createVNode("div", { class: "card-body" }, [
                    createVNode("div", { class: "row g-5" }, [
                      createVNode("div", { class: "fv-row col-md-6 col-sm-12" }, [

import { defineComponent, resolveComponent, mergeProps, withCtx, createTextVNode, createVNode, withModifiers, withDirectives, openBlock, createBlock, Fragment, renderList, toDisplayString, vModelSelect, createCommentVNode, useSSRContext } from "vue";
import { A as AppLayout } from "./AppLayout-b4759e43.mjs";
import { Link, Head } from "@inertiajs/inertia-vue3";
import SupplierList from "./SupplierList-79e0f87d.mjs";
import TopCard from "./TopCard-f9f46c84.mjs";
  ...
  _push(ssrRenderComponent(_component_app_layout, mergeProps({ title: _ctx.title }, _attrs), {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if (_ctx.supplier_projects.data.length >= 10) {
          _push2(`<div class="row"${_scopeId}><div class="col-sm-12 col-md-12 d-flex align-items-center justify-content-center"${_scopeId}><button class="btn btn-secondary"${_scopeId}>Load More</button></div></div>`);
        } else {
          _push2(`<!---->`);
        }
        _push2(`</div>`);
        ...
        return [
          ...
          createVNode("div", { class: "mb-5" }, [
            ...
            _ctx.supplier_projects.data.length >= 10 ? (openBlock(), createBlock("div", {
              key: 0,
              class: "row"
            }, [
              createVNode("div", { class: "col-sm-12 col-md-12 d-flex align-items-center justify-content-center" }, [
                createVNode("button", { class: "btn btn-secondary" }, "Load More")
              ])

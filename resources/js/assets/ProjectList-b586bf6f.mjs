...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList(_ctx.projects, (project, index) => {
    _push(`<div class="card mt-5 mb-5"><div class="card-body"><div class="d-flex align-items-center justify-content-between"><div class="col-2">`);
    _push(ssrRenderComponent(_component_Link, {
      class: "text-gray-800 text-hover-primary fs-6 fw-bold",
      href: `/project/${project == null ? void 0 : project.id}`
    }, {
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(project == null ? void 0 : project.project_name)}`);
        } else {
          return [
            createTextVNode(toDisplayString(project == null ? void 0 : project.project_name), 1)
          ];
        }
      }),
      _: 2
    }, _parent));
    _push(`<span class="text-muted fw-semibold d-block fs-7">${ssrInterpolate(project == null ? void 0 : project.project_id)}</span></div><div class="col-2 row text-center"><span class="text-gray-800 fs-6 fw-bold">Link Type</span><span class="text-muted">${ssrInterpolate(project == null ? void 0 : project.project_type)}</span></div><div class="col-2 row text-center"><span class="text-gray-800 fs-6 fw-bold">Added</span><span class="text-muted">${ssrInterpolate(project == null ? void 0 : project.created_at)}</span></div><div class="col-2 row text-center"><span class="text-gray-800 fs-6 fw-bold">Added By</span><span class="text-muted">${ssrInterpolate(project == null ? void 0 : project.user)}</span></div>`);

...
import AddressForm from "./AddressForm-cf8a97e6.mjs";
import Header from "./Header-0e5b2cdf.mjs";
import { toast } from "vue3-toastify";
import AddressCard from "./AddressCard-e4622b9b.mjs";
    ...
    confirmDelete(index) {
      Swal.fire({
        ...
        if (result.isConfirmed) {
          axios.delete(this.route("client.delAddress", this.addresses.data[index].id)).then((response) => {
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_address_form = resolveComponent("address-form");
  const _component_address_card = resolveComponent("address-card");
  _push(`<!--[-->`);
  ...
  _push(ssrRenderComponent(_component_app_layout, { title: _ctx.title }, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<div class="card"${_scopeId}><div class="card-header"${_scopeId}><div class="card-title m-0"${_scopeId}><h3 class="fw-bold m-0"${_scopeId}>Manage Address</h3></div>`);
        if (!_ctx.isEdit) {
          _push2(`<button class="btn btn-primary btn-sm align-self-center"${_scopeId}><i class="bi bi-plus-circle"${_scopeId}></i>Add New Address </button>`);
        } else {
          _push2(`<!---->`);
        }
        ...
        if (_ctx.isEdit || _ctx.isAdd) {
          ...
          _push2(ssrRenderComponent(_component_address_form, {
          ...
          ssrRenderList(_ctx.addresses.data, (address, index) => {
            _push2(`<div class="col-6 mb-5"${_scopeId}>`);
            _push2(ssrRenderComponent(_component_address_card, { address }, {
              action: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  return [
                    createVNode("div", { class: "d-flex align-items-center py-2" }, [
                      ...
                      createVNode("button", {
                        ...
                        onClick: ($event) => _ctx.toggleModal(true, address)
                      }, "Edit", 8, ["onClick"])
                    ])
                  ];
                }
          ...
          createVNode("div", { class: "card" }, [
            createVNode("div", { class: "card-header" }, [
              createVNode("div", { class: "card-title m-0" }, [
                createVNode("h3", { class: "fw-bold m-0" }, "Manage Address")
              ]),
            ...
            createVNode("div", { class: "card-body" }, [
              _ctx.isEdit || _ctx.isAdd ? (openBlock(), createBlock("div", {
                ...
                createVNode("div", { class: "col-6" }, [
                  createVNode(_component_address_form, {
                    onSubmitted: _ctx.submit,
                    countries: _ctx.countries.data,
                    address: _ctx.form,
                    client: _ctx.client.data
                    ...
                    _: 1
                  }, 8, ["onSubmitted", "countries", "address", "client"])
                ])
              ])) : (openBlock(), createBlock("div", {
                key: 1,
                class: "row"
              }, [
                (openBlock(true), createBlock(Fragment, null, renderList(_ctx.addresses.data, (address, index) => {
                  return openBlock(), createBlock("div", {
                    class: "col-6 mb-5",
                    key: index
                  }, [
                    createVNode(_component_address_card, { address }, {
                      action: withCtx(() => [
                        createVNode("div", { class: "d-flex align-items-center py-2" }, [
                          createVNode("button", {
                            class: "btn btn-sm btn-light btn-active-light-primary me-3",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Client/Address.vue");

  ...
  ssrRenderList(_ctx.projects, (project, index) => {
    ...
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        if (_push2) {
          _push2(`${ssrInterpolate(project.supplier.supplier_name)} (${ssrInterpolate(project.supplier.display_name)})`);
        } else {
          return [
            createTextVNode(toDisplayString(project.supplier.supplier_name) + " (" + toDisplayString(project.supplier.display_name) + ")", 1)
          ];
        }
      }),
      _: 2
    ...
    if (_ctx.$page.props.user.role.role.slug != "user") {
      _push(`<div class="flex-1 text-end"><div class="form-switch form-check-solid d-block form-check-custom form-check-success"><input class="form-check-input h-20px w-30px" type="checkbox"${ssrIncludeBooleanAttr(
        ((_a = project == null ? void 0 : project.supplier) == null ? void 0 : _a.status) == 1 ? true : false

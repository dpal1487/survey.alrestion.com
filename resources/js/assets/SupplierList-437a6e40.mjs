...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  ssrRenderList(_ctx.projects, (project, index) => {
    var _a, _b;
    _push(`<div class="card mb-5"><div class="card-body"><div class="d-flex justify-content-between align-items-center"><div class="flex-1">`);
    _push(ssrRenderComponent(_component_Link, {
      ...
      default: withCtx((_, _push2, _parent2, _scopeId) => {
        var _a2, _b2, _c, _d;
        if (_push2) {
          _push2(`${ssrInterpolate((_a2 = project.supplier) == null ? void 0 : _a2.supplier_name)} (${ssrInterpolate((_b2 = project.supplier) == null ? void 0 : _b2.display_name)})`);
        } else {
          return [
            createTextVNode(toDisplayString((_c = project.supplier) == null ? void 0 : _c.supplier_name) + " (" + toDisplayString((_d = project.supplier) == null ? void 0 : _d.display_name) + ")", 1)
          ];
        }
      }),
      _: 2
    }, _parent));
    _push(`<span class="text-muted fw-semibold d-block fs-7"><i class="bi bi-people-fill me-2"></i>${ssrInterpolate(project == null ? void 0 : project.project_name)} (${ssrInterpolate((_a = project == null ? void 0 : project.country) == null ? void 0 : _a.iso2)})</span></div>`);
    ...
    _push(`</div>`);
    if (_ctx.$page.props.user.role.role.slug != "user") {
      _push(`<div class="flex-1 text-end"><div class="form-switch form-check-solid d-block form-check-custom form-check-success"><input class="form-check-input h-20px w-30px" type="checkbox"${ssrIncludeBooleanAttr(
        ((_b = project == null ? void 0 : project.supplier) == null ? void 0 : _b.status) == 1 ? true : false
      ) ? " checked" : ""}><label class="form-check-label"> Status </label></div></div>`);
    } else {
      _push(`<!---->`);
    }
    if (_ctx.$page.props.user.role.role.slug != "user") {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Sampling/Components/SupplierList.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const SupplierList = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {

  ...
  data() {
    ...
    return {
      ...
      form: this.$inertia.form({
        ...
        role: ((_k = (_j = (_i = this.user) == null ? void 0 : _i.data) == null ? void 0 : _j.role) == null ? void 0 : _k.id) || "",
        password: ((_m = (_l = this.user) == null ? void 0 : _l.data) == null ? void 0 : _m.password) || "",
  ...
  _push(ssrRenderComponent(_component_AppLayout, { title: _ctx.title }, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<form autocomplete="off" class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10"${_scopeId}><div class="card"${_scopeId}><div class="card-header"${_scopeId}><div class="card-title"${_scopeId}><h2${_scopeId}>General</h2></div></div><div class="card-body"${_scopeId}><div class="row g-5"${_scopeId}><div class="fv-row col-md-6"${_scopeId}>`);
        ...
        _push2(`<!--]--></div><div class="fv-row col-md-6"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, { value: "Status" }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_Multiselect, {
          options: _ctx.status,
          label: "name",
          valueProp: "id",
        ...
        _push2(`<!--]--></div></div></div></div><div class="row"${_scopeId}><div class="col-12"${_scopeId}><div class="d-flex justify-content-end gap-5"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_Link, {
          href: "/users",
                ...
                createVNode("div", { class: "card" }, [
                  ...
                  createVNode("div", { class: "card-body" }, [
                    createVNode("div", { class: "row g-5" }, [
                      ...
                      createVNode("div", { class: "fv-row col-md-6" }, [
                        createVNode(_component_jet_label, { value: "Status" }),
                        createVNode(_component_Multiselect, {
                          options: _ctx.status,
                          label: "name",
                          valueProp: "id",

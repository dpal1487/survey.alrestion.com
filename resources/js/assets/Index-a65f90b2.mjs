  ...
  methods: {
    async confirmDelete(index) {
      ...
      await utils.deleteIndexDialog(
        route("supplier.destroy", this.suppliers.data[index].id),
        this.suppliers.data,
        index
      );
                        ...
                        createVNode("td", null, [
                          createVNode("button", {
                            ...
                            onClick: ($event) => {
                              var _a3;
                              return _ctx.doCopy(
                                (_a3 = supplier == null ? void 0 : supplier.supplier_redirect) == null ? void 0 : _a3.complete_url
                              );
                            }
                          }, " Copy Link ", 8, ["onClick"])
                        ]),
                        createVNode("td", null, [
                          createVNode("button", {
                            ...
                            onClick: ($event) => {
                              var _a3;
                              return _ctx.doCopy(
                                (_a3 = supplier == null ? void 0 : supplier.supplier_redirect) == null ? void 0 : _a3.terminate_url
                              );
                            }
                          }, " Copy Link ", 8, ["onClick"])
                        ]),
                        createVNode("td", null, [
                          createVNode("button", {
                            ...
                            onClick: ($event) => {
                              var _a3;
                              return _ctx.doCopy(
                                (_a3 = supplier == null ? void 0 : supplier.supplier_redirect) == null ? void 0 : _a3.quotafull_url
                              );
                            }
                          }, " Copy Link ", 8, ["onClick"])
                        ]),
                        createVNode("td", null, [
                          createVNode("button", {
                            ...
                            onClick: ($event) => {
                              var _a3;
                              return _ctx.doCopy(
                                (_a3 = supplier == null ? void 0 : supplier.supplier_redirect) == null ? void 0 : _a3.security_terminate_url
                              );
                            }
                          }, " Copy Link ", 8, ["onClick"])
                        ]),

  ...
  _push(ssrRenderComponent(_component_app_layout, { title: _ctx.title }, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`<!--]--></div><div class="row mb-3"${_scopeId}><div class="col-md-6 col-sm-12"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "project-client",
        ...
        _push2(`<!--]--></div><div class="col-md-6 col-sm-12"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "project-country",
        ...
        _push2(`<!--]--></div></div><div class="row mb-3"${_scopeId}><div class="col-md-6 col-sm-12"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "project-start",
        ...
        _push2(`<!--]--></div></div><div class="row"${_scopeId}><div class="col-12"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "project-target",
          value: "Project Target"
        }, null, _parent2, _scopeId));
        _push2(`<textarea rows="5" class="form-control form-control-solid" id="project-target" placeholder="Type important message here..."${_scopeId}>${ssrInterpolate(_ctx.form.target)}</textarea></div></div></div></div><div class="card card-flush py-4"${_scopeId}><div class="card-header"${_scopeId}><div class="card-title"${_scopeId}><h2${_scopeId}>Pricing</h2></div></div><div class="card-body pt-0"${_scopeId}><div class="row mb-3"${_scopeId}><div class="col-12"${_scopeId}>`);
        _push2(ssrRenderComponent(_component_jet_label, {
          for: "project-link",
          value: "Project Link"
        }, null, _parent2, _scopeId));
        ...
        return [
          ...
          createVNode("form", {
            ...
            createVNode("div", { class: "d-flex flex-column gap-5 w-100 w-lg-300px mb-7 me-lg-5 col-sm-12" }, [
              ...
              createVNode("div", { class: "card card-flush py-4" }, [
                ...
                createVNode("div", { class: "card-body pt-0" }, [
                  ...
                  createVNode("div", { class: "row mb-3" }, [
                    createVNode("div", { class: "col-md-6 col-sm-12" }, [
                      createVNode(_component_jet_label, {
                        for: "project-client",
                        value: "Project Client"
                      }),

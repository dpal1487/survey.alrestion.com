    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      if (_push2) {
        ...
        if (_ctx.isEdit) {
          ...
          _push2(`<!--]--></div></div></div><div class="row mb-6"${_scopeId}><label class="col-lg-4 col-form-label required fw-semibold fs-6"${_scopeId}>Gender</label><div class="col-lg-8 fv-row fv-plugins-icon-container"${_scopeId}><div class="d-flex align-items-center mt-3"${_scopeId}><label class="form-check form-check-custom form-check-inline form-check-solid me-5"${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(_ctx.v$.form.gender.$model, "male")) ? " checked" : ""} class="${ssrRenderClass([
            _ctx.v$.form.gender.$errors.length > 0 ? "is-invalid" : "",
            "form-check-input"
          ])}" value="male"${_scopeId}><span class="fw-semibold ps-2 fs-6"${_scopeId}> Male </span></label><label class="form-check form-check-custom form-check-inline form-check-solid"${_scopeId}><input name="gender" type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(_ctx.v$.form.gender.$model, "female")) ? " checked" : ""} class="${ssrRenderClass([
            _ctx.v$.form.gender.$errors.length > 0 ? "is-invalid" : "",
            "form-check-input"
                          ...
                          createVNode("div", { class: "d-flex align-items-center mt-3" }, [
                            createVNode("label", { class: "form-check form-check-custom form-check-inline form-check-solid me-5" }, [
                              withDirectives(createVNode("input", {
                                ...
                                [vModelRadio, _ctx.v$.form.gender.$model]
                              ]),

...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<form autocomplete="off"><div class="row g-5"><div class="fv-row col-md-6 col-sm-12">`);
  ...
  _push(`<!--]--></div><div class="fv-row col-md-6 col-sm-12"><div class="fv-row">`);
  _push(ssrRenderComponent(_component_jet_label, {
    for: "project-status",
  ...
  _push(`<!--]--></div></div>`);
  if (_ctx.route().current() != "sampling.edit") {
    _push(`<div class="fv-row col-12"><div class="form-check"><input class="form-check-input"${ssrIncludeBooleanAttr(Array.isArray(_ctx.form.add_more) ? ssrLooseContain(_ctx.form.add_more, "") : _ctx.form.add_more) ? " checked" : ""} type="checkbox" value="" id="addMore"><label class="form-check-label" for="addMore"> Add More Supplier </label></div></div>`);
  } else {
    _push(`<!---->`);
  }

    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        if (_ctx.clients.meta) {
          _push2(`<div class="row"${_scopeId}><div class="col-sm-12 d-flex align-items-center justify-content-between"${_scopeId}><span class="fw-bold text-gray-700"${_scopeId}> Showing ${ssrInterpolate(_ctx.clients.meta.from)} to ${ssrInterpolate(_ctx.clients.meta.to)} of ${ssrInterpolate(_ctx.clients.meta.total)} entries </span>`);

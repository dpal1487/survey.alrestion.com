    ...
    methods: {
        submit(form) {
            ...
            this.form.transform((data) => ({
                ...
                .post(this.route("sampling.update", this.supplier_project.data.id),
                    {
                        onSuccess: (data) => {
...
<template>
    ...
    <app-layout title="Edit Supplier">
        ...
        <div class="mb-5">
            <div class="card">
                <div class="card-header align-items-center ps-2">
                    <div class="card-title">
                        <h2>Supplier Projects</h2>
                    </div>
                </div>
            </div>
            <SupplierList :projects="projects.data" />
            <div class="row">

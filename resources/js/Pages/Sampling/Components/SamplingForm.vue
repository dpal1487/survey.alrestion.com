    ...
    data() {
        return {
            ...
            form: this.$inertia.form({
                id: this.supplier_project?.id,
                project_link_id: this.project?.id,
                project_id: this.project?.project_id,
                project_name: this.supplier_project?.project_name,
                project_cpi: this.supplier_project?.cpi,
                complete_url: this.supplier_project?.complete_url,
                terminate_url: this.supplier_project?.terminate_url,
                quotafull_url: this.supplier_project?.quotafull_url,
                security_terminate_url: this.supplier_project?.security_terminate_url,
                sample_size: this.supplier_project?.sample_size,
    ...
    <form @submit.prevent="submit" autocomplete="off">
        <div class="row g-5">
            <div class="fv-row col-md-6 col-sm-12">
                ...
                <Multiselect :canClear="false" :options="suppliers" label="label" valueProp="id"

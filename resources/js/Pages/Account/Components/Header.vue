        ...
        <div class="card-body pt-9 pb-0">
            ...
            <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                ...
                <div class="me-7 mb-4">
                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                        ...
                        <img v-else src="/assets/media/avatars/300-1.jpg" alt="image">
                        <div
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                <li class="nav-item mt-2">
                    <Link
                        :class="`nav-link text-active-primary ms-0 me-10 py-5 ${route().current('account.index') && 'active'}`"
                ...
                <li class="nav-item mt-2">
                    ...
                    <Link
                        :class="`nav-link text-active-primary ms-0 me-10 py-5 ${route().current('account.projects') && 'active'}`"
                        href="/account/projects"> Projects
                    </Link>
                </li>
            </ul>
        </div>

    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-body pt-9 pb-0">
                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        <div class="d-flex flex-column">
                            <div class="d-flex align-items-center mb-2">
                                <a href="#" class="text-gray-900 text-hover-primary fs-2 fw-bold me-1 text-capitalize">{{
                                    client.name }}</a>
                                <a href="#">
                            ...
                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                <span
                                    ...
                                    <span>
                                        ...
                                        {{ address[0]?.country?.name }} - {{ address[0]?.pincode }}
                                    </span>
                                </span>
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
                ...
                <li class="nav-item mt-2">
                    <Link class="nav-link text-active-primary ms-0 me-10 py-5" :href="`/client/${client.id}/addresses`"
                        :class="route().current() == 'client.addresses' ? 'active' : ''">
                    Address
                    </Link>
                </li>
            </ul>

    ...
    <div class="card card-flush mb-5">
        <div class="card-header align-items-center">
            ...
            <div v-if="$page.props.user.role.role.slug != 'user'">
                ...
                <a target="_blank" class="btn btn-primary m-1 btn-sm" :href="`/project/${project.id}/export`"><i
                        class="bi bi-file-earmark-arrow-up"></i>Export
                    ID's </a>
        ...
        <div class="card-body p-0">
            <div class="row">
                <div class="col-12" v-if="isEdit">
                    <form @submit.prevent="submit" autocomplete="off" class="ps-5 pt-5">
                        <div class="row g-5">
                            <div class="fv-row col-12">
                                <jet-label for="project-name" value="Project Name" />
                                <jet-input id="project-name" type="text" placeholder="Enter project Name / ID"
                                    v-model="v$.form.project_name.$model" :class="v$.form.project_name.$errors
                                        .length > 0
                                        ? 'is-invalid'
                                        : ''
                                        " />
                            ...
                            <div class="fv-row col-md-6">
                                ...
                                <Multiselect id="link-type" :canClear="false" :options="[
                                    ...
                                    placeholder="Select link type" :class="v$.form.project_type.$errors
                                        .length > 0
                                        ? 'is-invalid'
                                        : ''
                            ...
                            <div class="fv-row col-md-6 fs-5">
                                ...
                                <input type="date" v-model="v$.form.start_date.$model"
                                    ...
                                    placeholder="Enter project start date" :class="v$.form.start_date.$errors.length >
                                        0
                                        ? 'is-invalid'
                                        : ''
                                        " />
                            ...
                            <div class="fv-row col-md-6">
                                ...
                                <Multiselect :can-clear="false" id="project-status" :options="devices" label="label"
                                    ...
                                    mode="tags" :close-on-select="false" :create-option="true" :class="v$.form.device_type.$errors.length >
                                        0
                                        ? 'is-invalid'
                                        : ''
                            ...
                            <div class="fv-row col-md-6 col-sm-12">
                                ...
                                <Multiselect :canClear="false" id="project-status" :options="status" label="label"
                                    valueProp="value" class="form-control form-control-solid" placeholder="Select status"
                                    :class="v$.form.project_status.$errors
                                        .length > 0
                                        ? 'is-invalid'
                                        : ''
                    ...
                    <table class="table table-striped table-bordered text-center align-middle">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="fs-6 fw-bold text-gray-800">
                                    <Link :href="`/client/${project.client.id}`" v-if="$page.props.user.role.role
                                        .slug != 'user'
            ...
            <ul class="nav nav-stretch nav-line-tabs border-top fs-5 fw-bold px-5">
                <li class="nav-item">
                    <Link class="nav-link text-active-primary ms-0 me-10 py-5" :class="route().current() == 'project.show'
                        ? 'active'
                        : ''
                        " :href="`/project/${project.id}`" v-if="$page.props.user.role.role.slug == 'user' ||
        ...
        ">
                ...
                <li class="nav-item">
                    <Link class="nav-link text-active-primary ms-0 me-10 py-5" :class="route().current() == 'project.suppliers'
                        ? 'active'
                        : ''
